...
A proposta do projeto é simular a experiência de personalização de pedidos em tempo real, focando na interação com o usuário, na usabilidade e no visual atrativo para o público jovem.

Melhorias futuras:
- Melhorar a responsividade do site;
- Atribuir um back-end;
- Melhoria UI\UX;

https://seuburguer.vercel.app/
